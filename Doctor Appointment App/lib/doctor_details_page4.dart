...
class DoctorDetailPage4 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _DoctorDetailState();
}

class _DoctorDetailState extends State<DoctorDetailPage4> {
  randevuAlindi() async {
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text('Op. Dr. Murat Aziz Vatansever',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 22,
                                fontFamily: 'Roboto',
