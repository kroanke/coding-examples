...
class DoctorDetailPage2 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _DoctorDetailState();
}

class _DoctorDetailState extends State<DoctorDetailPage2> {
  randevuAlindi() async {
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text('Prof. Dr. Bahar Sezer',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 22,
                                fontFamily: 'Roboto',
